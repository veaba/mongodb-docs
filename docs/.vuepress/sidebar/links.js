...
module.exports = {
	...
	installationLinks: [
		...
		{
			type: "group",
			title: "administration/install-community",
			link: "administration/install-community",
			children: [
				{
					type:"group",
					...
					children: [
						// 'tutorial/install-mongodb-on-red-hat',
						{
							...
							type:'group',
							link:"tutorial/install-mongodb-on-red-hat"
						},
						{
							title:"Install on Red Hat",
							type:'group',
		...
		'administration/install-mongodb-on-os-x',
		'administration/install-mongodb-on-windows',
		...
		//支持多级嵌套
		{
			...
			title: "haha",
			collapsable: false,
			link: 'tutorial/verify-mongodb-packages',
			children: ['tutorial/configure-mongo-shell', 'tutorial/write-scripts-for-the-mongo-shell']
		}
	],
	theMongoShellLinks: [
